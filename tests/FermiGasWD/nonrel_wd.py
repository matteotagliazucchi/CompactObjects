...
print('=========================================================')
print('Fermi White Dwarf in the non-relativistic polytropic case.')
...
p0_min = 0.5e22*conversion_dict['cgs']['pressure']['geom']
p0_max = 5.0e22*conversion_dict['cgs']['pressure']['geom']
